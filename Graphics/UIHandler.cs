...
namespace HololiveFightingGame.Graphics
{
	public class UIHandler
	{
		...
		public UIHandler()
		{
			...
			uiDrawObject.texture = new SlicedSprite(Assets.inGameUI);
			for (int i = 0; i < 10; i++)
			{
				int x = i % 5;
				int y = i / 5;
	...
	public class UIDrawObject : DrawObject
	{
		...
		{
			spriteBatch.DrawString(Assets.font, Game1.language.GetLocalizedString("Test"), Vector2.Zero, Color.White);
